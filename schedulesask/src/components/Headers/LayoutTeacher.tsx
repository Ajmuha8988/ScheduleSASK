...
import ValidationTeacher from '../../utils/Validation/ValidationPageTeacher'
import RoutingGroup from '../Routing/RoutingGroups'
import { useNavigate } from 'react-router-dom'
import { BeatLoader } from 'react-spinners';

const LayoutTeacher = () => {
    const { Firstname, Patronymic, loading } = ValidationTeacher();
                ...
                <div className="spinner-container">
                    ...
                    <header className="bg-dark font-for-headers">
                        <nav className="navbar navbar-dark navbar-expand-lg navbar-warning bg-dark container">
                            <a className="navbar-brand" onClick={() => navigate('/teachers')} >
                            ...
                            <div className="collapse navbar-collapse justify-content-start" id="navbarNav">
                                <ul className="navbar-nav">
                                    <li className="nav-item mobile-fio" >
                            ...
                            <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
                                <ul className="navbar-nav">
                                    <li className="nav-item mobile-fio-disabled">
                                        <label className="ms-2 text-light d-inline-block px-2 py-1" >Добро пожаловать, {Firstname} {Patronymic} !</label>
                                    </li>
                                    <li className="nav-item">
                                        <LogoutButton />
